    ...
    <>
      ...
      <div className={`mobile-menu-overlay ${isMobileMenuOpen ? 'open' : ''}`}>
        <div className="mobile-nav-links">
          ...
          <a href="/#contact" className="client-portal-btn mobile-client-portal" onClick={toggleMobileMenu}>Client Portal</a>
          <Link to="/contact" className="lets-talk-btn mobile-lets-talk" onClick={toggleMobileMenu}>
      ...
      <nav className="navbar">
        ...
        <div className="nav-action desktop-only">
          <a href="/#contact" className="client-portal-link">Client Portal</a>
