      ...
      <div className="footer-container">
        ...
        <div className="footer-content global-container">
          ...
          <div className="footer-socials">
            <a href="mailto:support@thecopperstudio.com" className="social-icon" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://wa.me/919820933877" className="social-icon" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.instagram.com/the_copperstudio/" className="social-icon" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.linkedin.com/company/thecopperstudio" className="social-icon" target="_blank" rel="noopener noreferrer">
